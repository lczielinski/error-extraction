...
let f_X input_array = 
  ...
  let ref_2 = (ref_1 -$ var_c) in
  let ref_3 = (ref_2 *$ {low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00}) in
  let ref_4 = (var_a +$ var_b) in
  let ref_5 = (ref_3 +$ ref_4) in
  let ref_6 = (ref_5 *$ ref_0) in
  let ref_7 = (ref_1 -$ var_b) in
  let ref_8 = (ref_7 *$ {low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00}) in
  let ref_9 = (ref_8 +$ ref_4) in
  let ref_10 = (ref_9 *$ ref_0) in
  let ref_11 = (ref_6 *$ ref_10) in
  let ref_12 = (var_c +$ ref_4) in
  ((ref_11 *$ (ref_12 *$ {low = 1.00000000000000000000e+00; high = 1.00000000000000000000e+00})) /$ ({low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00} *$ sqrt_I(((((ref_4 +$ ((ref_1 -$ var_a) *$ {low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00})) *$ ({low = 1.00000000000000000000e+00; high = 1.00000000000000000000e+00} /$ {low = 4.00000000000000000000e+00; high = 4.00000000000000000000e+00})) *$ ref_12) *$ ref_11))))
