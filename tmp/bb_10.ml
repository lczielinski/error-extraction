...
let f_X input_array = 
  ...
  let ref_12 = (ref_4 +$ var_c) in
  ((ref_11 *$ (ref_12 *$ {low = 1.00000000000000000000e+00; high = 1.00000000000000000000e+00})) /$ ({low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00} *$ sqrt_I((ref_11 *$ (ref_12 *$ ((ref_4 +$ ((ref_1 -$ var_a) *$ {low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00})) *$ ({low = 1.00000000000000000000e+00; high = 1.00000000000000000000e+00} /$ {low = 4.00000000000000000000e+00; high = 4.00000000000000000000e+00})))))))
