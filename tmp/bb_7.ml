...
let f_X input_array = 
  ...
  ((ref_10 *$ {low = 2.40000000000000000000e+01; high = 2.40000000000000000000e+01}) /$ ({low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00} *$ sqrt_I((ref_10 *$ ((var_b *$ (ref_11 -$ (((var_a +$ (var_a *$ ({low = 1.00000000000000000000e+00; high = 1.00000000000000000000e+00} /$ (~-$({low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00}))))) -$ (var_b *$ ref_12)) *$ ref_12))) +$ ((((var_c -$ (ref_14 -$ var_b)) *$ var_a) *$ ref_9) -$ (((ref_14 -$ var_c) -$ var_b) *$ ref_11)))))))
