...
Lower is better. ours 4 / herbie 4 / tie 36 / unscored 0
...
| fastmath_dist4 | 0.75 | 0.45 | 0.53 | tie |
| floudas1 | 0.24 | 0.18 | 0.08 | tie |
| floudas3 | 0.14 | 0.14 | 0.14 | tie |
| himmilbeau | 0.04 | 0.01 | 0.03 | tie |
| jetengine | 0.63 | 0.65 | 0.56 | tie |
| kahan_p9 | 0.02 | 0.02 | 0.02 | tie |
| kepler0 | 0.56 | 0.28 | 0.28 | tie |
| kepler1 | 0.77 | 0.57 | 0.60 | tie |
| kepler2 | 1.29 | 0.49 | 0.94 | ours |
...
| sum | 0.35 | 0.15 | 0.14 | tie |
| test03_nonlin2 | 0.04 | 0.03 | 0.03 | tie |
| test04_dqmom9 | 0.64 | 0.45 | 0.48 | tie |
| test05_nonlin1_r4 | 0.76 | 0.33 | 0.36 | tie |
| triangle | 2.55 | 0.31 | 0.62 | ours |
| triangle1 | 1.13 | 0.26 | 0.45 | ours |

## Worst-case error over the box (FPTaylor)

`-` for Herbie means its output branches or left the subset, so it wasn't bounded. ours 17 / herbie 6 / tie 4 / uncompared 17
...
| himmilbeau | 5.8e-13 abs | 4.9e-13 abs | herbie |
| jetengine | 7.2e-12 abs | - | - |
| kahan_p9 | 3.7e-12 abs | 4.0e-12 abs | ours |
| kepler0 | 2.8 ulp | 2.2 ulp | herbie |
| kepler1 | 10.1 ulp | - | - |
| kepler2 | 27.4 ulp | 46.7 ulp | ours |
| martel_p6 | 7.2e-16 abs | 1.3e-15 abs | ours |
| matrixdeterminant | 1.6e-12 abs | - | - |
| matrixdeterminant2 | 1.6e-12 abs | - | - |
| nmse_example_3_1 | 1.6 ulp | 5.1 ulp | ours |
| nmse_example_3_6 | 126.1 ulp | - | - |
| nmse_p42_negative | 13.3 ulp | 3.4e-14 abs | herbie |
| nmse_p42_positive | 422381.0 ulp* | 3.4e-14 abs | ours |
...
| sine | 3.3e-16 abs | 4.2e-16 abs | ours |
| som_setup_w | 8.5e-17 abs | - | - |
| sum | 0.8 ulp | - | - |
